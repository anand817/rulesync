...
export const RULESYNC_CONFIG_SCHEMA_URL =
  "https://github.com/anand817/rulesync/releases/latest/download/config-schema.json";
export const RULESYNC_MCP_SCHEMA_URL =
  "https://github.com/anand817/rulesync/releases/latest/download/mcp-schema.json";
export const RULESYNC_PERMISSIONS_SCHEMA_URL =
  "https://github.com/anand817/rulesync/releases/latest/download/permissions-schema.json";
