...
const FetchOptionsSchema = z.looseObject({
  ...
  rulesPaths: z.optional(z.array(z.string())),
  rulesFiles: z.optional(z.array(z.string())),
  commandsPaths: z.optional(z.array(z.string())),
  commandsFiles: z.optional(z.array(z.string())),
  subagentsPaths: z.optional(z.array(z.string())),
  subagentsFiles: z.optional(z.array(z.string())),
